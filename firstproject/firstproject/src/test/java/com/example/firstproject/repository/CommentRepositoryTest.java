...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        /* Case 3:9번 게시글의 모든 댓글 조회 */
        {
            ...
            //검증
            assertEquals(expected.toString(),comments.toString(),"9번 글도 없고 댓글도 없음");
        }
        /* Case 4:9999번 게시글의 모든 댓글 조회 */
        {
            ...
            //검증
            assertEquals(expected.toString(),comments.toString(),"9999번 글도 없고 댓글도 없음");
        }
        /* Case 5:-1번 게시글의 모든 댓글 조회 */
        {
            ...
            //검증
            assertEquals(expected.toString(),comments.toString(),"-1번 글도 없고 댓글도 없음");
        }
    }
